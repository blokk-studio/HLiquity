import untypedStabilityPoolAbi from './StabilityPool.json'

export const stabilityPoolAbi = untypedStabilityPoolAbi as StabilityPoolAbi
      
export type StabilityPoolAbi = [
  {
    "anonymous": false,
    "inputs": [
      {
