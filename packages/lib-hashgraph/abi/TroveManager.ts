import untypedTroveManagerAbi from './TroveManager.json'

export const troveManagerAbi = untypedTroveManagerAbi as TroveManagerAbi
      
export type TroveManagerAbi = [
  {
    "anonymous": false,
    "inputs": [
      {
    ...
    "inputs": [
      {
        "indexed": false,
        "internalType": "uint256",
        "name": "_attemptedHCHFAmount",
        "type": "uint256"
      },
      {
        "indexed": false,
        "internalType": "uint256",
        "name": "_actualHCHFAmount",
        "type": "uint256"
      },
      {
        "indexed": false,
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "contract IHLQTStaking",
        "name": "",
        "type": "address"
      }
    ],
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "contract IHLQTToken",
        "name": "",
        "type": "address"
      }
    ],
  ...
  {
    "inputs": [],
    "name": "lastHCHFDebtError_Redistribution",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
