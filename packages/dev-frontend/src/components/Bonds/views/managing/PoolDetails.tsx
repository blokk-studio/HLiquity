    ...
    <details>
      ...
      <Box sx={{ mt: 3 }}>
        ...
        <StaticRow label="Pool balance ratio">
          ...
          >
            <PoolBalance symbol="bHCHF">1</PoolBalance>
            <Text sx={{ fontWeight: "thin", mx: "6px" }}>:</Text>
            <PoolBalance symbol="HCHF-3CRV">{poolBalanceRatio.prettify(2)}</PoolBalance>
          </StaticAmounts>
        </StaticRow>
