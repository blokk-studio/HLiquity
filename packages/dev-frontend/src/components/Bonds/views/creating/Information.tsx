...
export const Information: React.FC = () => {
  ...
  return (
    <InformationContainer>
      <Box sx={{ p: [2, 3] }}>
        <Paragraph sx={{ mt: 2 }}>
          Bonds accrue a virtual balance of boosted HCHF tokens (bHCHF) over time. At any time, the
          bonder may choose to claim their bHCHF in exchange for their HCHF, or cancel their bond to
          recover their deposited HCHF.
        </Paragraph>
        <Paragraph sx={{ mt: 3 }}>
          Please visit the&nbsp;
