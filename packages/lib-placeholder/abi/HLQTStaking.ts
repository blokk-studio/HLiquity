import untypedHLQTStakingAbi from './HLQTStaking.json'

export const hLQTStakingAbi = untypedHLQTStakingAbi as HLQTStakingAbi
      
export type HLQTStakingAbi = [
  {
    "anonymous": false,
    "inputs": [
      {
    ...
    "inputs": [
      {
        "indexed": false,
        "internalType": "uint256",
        "name": "_totalHLQTStaked",
        "type": "uint256"
      }
    ],
    "name": "TotalHLQTStakedUpdated",
    "type": "event"
  },
  {
    "anonymous": false,
