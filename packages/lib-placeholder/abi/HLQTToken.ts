import untypedHLQTTokenAbi from './HLQTToken.json'

export const hLQTTokenAbi = untypedHLQTTokenAbi as HLQTTokenAbi
      
export type HLQTTokenAbi = [
  {
    "inputs": [
      {
  ...
  },
  {
    ...
    "inputs": [
      ...
      },
      {
        ...
        "indexed": false,
        "internalType": "struct IHLQTToken.UpdateTokenStruct",
