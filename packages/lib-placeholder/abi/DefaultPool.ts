import untypedDefaultPoolAbi from './DefaultPool.json'

export const defaultPoolAbi = untypedDefaultPoolAbi as DefaultPoolAbi
      
export type DefaultPoolAbi = [
  {
    "anonymous": false,
    "inputs": [
      {
  ...
  },
  {
    ...
    "name": "DefaultPoolHCHFDebtUpdated",
    "type": "event"
  },
  {
    "anonymous": false,
