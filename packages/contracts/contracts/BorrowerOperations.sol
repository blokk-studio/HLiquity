...
contract BorrowerOperations is LiquityBase, Ownable, CheckContract, IBorrowerOperations {
    ...
    IHLQTYStaking public lqtyStaking;
    ...
    */
    ...
    function closeTrove() external override {
        ...
        IDCHFToken lusdTokenCached = lusdToken;
    ...
    function _triggerBorrowingFee(ITroveManager _troveManager, IDCHFToken _lusdToken, uint _LUSDAmount, uint _maxFeePercentage) internal returns (uint) {
    ...
    function _withdrawLUSD(IActivePool _activePool, IDCHFToken _lusdToken, address _account, uint _LUSDAmount, uint _netDebtIncrease) internal {
    ...
    function _requireCallerIsStabilityPool() internal view {
     ...
     function _requireSufficientLUSDBalance(IDCHFToken _lusdToken, address _borrower, uint _debtRepayment) internal view {
