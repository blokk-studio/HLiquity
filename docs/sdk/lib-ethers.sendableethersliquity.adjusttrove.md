...
|  maxBorrowingRate | [Decimalish](./lib-base.decimalish.md) | Maximum acceptable [borrowing rate](./lib-base.fees.borrowingrate.md) if <code>params</code> includes <code>borrowDCHF</code>. |
...
The transaction will fail if the Trove's debt would fall below [DCHF\_MINIMUM\_DEBT](./lib-base.dchf_minimum_debt.md)<!-- -->.
