...
|  [approveUniTokens(allowance)](./lib-base.transactableliquity.approveunitokens.md) | Allow the liquidity mining contract to use Uniswap ETH/DCHF LP tokens for [staking](./lib-base.transactableliquity.stakeunitokens.md)<!-- -->. |
|  [borrowDCHF(amount, maxBorrowingRate)](./lib-base.transactableliquity.borrowdchf.md) | Adjust existing Trove by borrowing more DCHF. |
...
|  [depositDCHFInStabilityPool(amount, frontendTag)](./lib-base.transactableliquity.depositdchfinstabilitypool.md) | Make a new Stability Deposit, or top up existing one. |
...
|  [openTrove(params, maxBorrowingRate)](./lib-base.transactableliquity.opentrove.md) | Open a new Trove by depositing collateral and borrowing DCHF. |
|  [redeemDCHF(amount, maxRedemptionRate)](./lib-base.transactableliquity.redeemdchf.md) | Redeem DCHF to native currency (e.g. Ether) at face value. |
...
|  [repayDCHF(amount)](./lib-base.transactableliquity.repaydchf.md) | Adjust existing Trove by repaying some of its debt. |
...
|  [stakeUniTokens(amount)](./lib-base.transactableliquity.stakeunitokens.md) | Stake Uniswap ETH/DCHF LP tokens to participate in liquidity mining and earn HLQTY. |
...
|  [unstakeUniTokens(amount)](./lib-base.transactableliquity.unstakeunitokens.md) | Withdraw Uniswap ETH/DCHF LP tokens from liquidity mining. |
...
|  [withdrawDCHFFromStabilityPool(amount)](./lib-base.transactableliquity.withdrawdchffromstabilitypool.md) | Withdraw DCHF from Stability Deposit. |
